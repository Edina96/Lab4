...
namespace Snake
{
	...
	class Program
	{
		...
		public void gameOver(Queue<Position> snakeElements, int negativePoints, int bonus, int lvlNum)
		{
			playGameOverSound();
		...
		public void winGame(int negativePoints, int eatenTimes, Queue<Position> snakeElements, int bonus, int lvlNum)
		{
			if (eatenTimes == 5)
			{
				playWinSound();
